...
class Task(ABC):
    ...
    @abstractmethod
    def compute_reward(self, observation: np.ndarray, achieved_goal: np.ndarray, desired_goal: np.ndarray, info: Dict[str, Any] = {}) -> np.ndarray:
...
class RobotTaskEnv(gym.Env):
    ...
    def step(self, action: np.ndarray) -> Tuple[Dict[str, np.ndarray], float, bool, bool, Dict[str, Any]]:
        ...
        reward = float(self.task.compute_reward(observation["observation"], observation["achieved_goal"], self.task.get_goal(), info))
