...
class Panda(PyBulletRobot):
    ...
    def __init__(
        ...
        self.neutral_joint_values = np.array([0.00, 0.5, 0.0, -2.5, 0.5, 2.26, 0.79, 0.00, 0.00])
        self.ee_link = 11
    ...
    def set_action(self, action: np.ndarray) -> None:
        # Conversion to discrete +x, -x, +y, -y, +z, -z
        xy = [[0.005, 0., 0.],
                [-0.005, 0., 0.],
                [0., 0.005, 0.],
                [0., -0.005, 0.],
